<template x-teleport="body">
  <div id="confirm-brand-deletion-modal" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <form :action="'{{ route('admin.brands.destroy', '') }}/' + brandToDeleteId" class="p-4 md:p-5 text-center"
          method="post">
          @csrf
          @method('DELETE')
          <x-icons.question-mark-circle class="mx-auto mb-4 text-gray-400 w-16 h-16 dark:text-gray-200" />
          <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
            {{ __('Are you sure you want to remove this brand?') }}
          </h3>
