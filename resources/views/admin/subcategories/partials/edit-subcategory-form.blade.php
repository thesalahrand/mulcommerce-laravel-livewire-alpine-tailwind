<section class="w-full max-w-3xl">
  <form method="post" action="{{ route('admin.subcategories.update', $subcategory->id) }}" enctype="multipart/form-data">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
      <div x-data="imageViewer(@js($subcategory->getFirstMediaUrl('subcategory-photos', 'thumb') ?: asset('images/placeholder-image.png')))">
    ...
    <div class="flex items-start mt-6">
      <div class="flex items-start">
        <div class="flex items-center h-5">
          <x-checkbox-input id="is_active" name="is_active" :checked="$subcategory->is_active" />
        </div>
