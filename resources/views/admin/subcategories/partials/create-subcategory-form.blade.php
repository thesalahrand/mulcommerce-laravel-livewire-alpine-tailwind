<section class="w-full max-w-3xl">
  <form method="post" action="{{ route('admin.subcategories.store') }}" enctype="multipart/form-data">
    ...
    <h5 class="text-xl font-semibold text-gray-900 dark:text-white"> {{ __('Add Subcategory Details') }} </h5>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
      ...
      <div>
        ...
        <x-select-input id="category_id" name="category_id" type="text" :options="$categories"
          chooseOptionText="Select a Category" :selectedOption="old('category_id')" required autocomplete="category_id" />
